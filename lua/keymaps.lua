...
map('n', '<leader>R', ':lua RgCurrentWord()<CR>', {noremap = true, silent = true})
...
function _G.RgCurrentSelected()
    ...
    lines[#lines] = string.sub(lines[#lines], 0, column_end - (o.selection == 'inclusive' and 0 or 1))
...
map('n', '<leader>C', ':<C-U>Commands!<cr>', {})
map('n', '<leader>l', ':<C-U>Lines<cr>', {})
...
map('n', '<leader>yp', ':let @* = expand("%") . ":" . line(".")<CR>', {noremap = true})
map('n', '<leader>yP', ':let @* = expand("%:p") . ":" . line(".")<CR>', {noremap = true})

map('n', '<leader>Fp', ':norm yy<CR>:let @* = expand("%") . ":" . line(".") . ":" . @"<CR>', {noremap = true, silent = true})
map('n', '<leader>FP', ':norm yy<CR>:let @* = expand("%:p") . ":" . line(".") . ":" . @"<CR>', {noremap = true, silent = true})
...
map('n', '<leader><space>', 'za', {noremap = true})
