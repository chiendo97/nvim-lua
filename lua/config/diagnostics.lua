...
diagnostics.config = {
    ...
    beacon = {
        ...
        default = {
            ...
            to = function()
                local bg =
                    vim.api.nvim_get_hl(0, { name = vim.o.statusline and "Cursorline" or "Normal", link = false }).bg
...
diagnostics.hover = function(window)
    ...
    local beacon_config =
        vim.tbl_extend("force", get_beacon_config("default", {}, true), get_beacon_config(level, {}, true) or {})
