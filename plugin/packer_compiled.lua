...
_G.packer_plugins = {
  ...
  ["gotests-vim"] = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/gotests-vim"
  },
  ["gruvbox-flat.nvim"] = {
    loaded = true,
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua"
  },
  ["nvim-compe"] = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/vim-gitgutter"
  },
  ["vim-go"] = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/vim-go"
  },
  ["vim-sandwich"] = {
    loaded = true,
  ...
  winresizer = {
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/winresizer"
  }
}
