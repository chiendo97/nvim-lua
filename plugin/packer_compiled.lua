...
_G.packer_plugins = {
  ...
  catppuccin = {
    ...
    loaded = true,
    path = "/Users/chien.le/.local/share/nvim/site/pack/packer/start/catppuccin",
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'go-tag', 'gotests-vim'}, { ft = "go" }, _G.packer_plugins)]]
